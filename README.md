...
```	
plink2 --bfile  merged_Updated_2_QC_remove_related --pheno 1KG_SEX_PCA_pheno.txt --pheno-name Pheno1 --covar 1KG_SEX_PCA_pheno.txt --covar-name Sex-PC5 --glm firth-fallback cols=+a1freq  hide-covar --out GWAS_SEX_wPC_Pheno1
PLINK v2.00a3LM 64-bit Intel (5 May 2021)      www.cog-genomics.org/plink/2.0/
(C) 2005-2021 Shaun Purcell, Christopher Chang   GNU General Public License v3
Logging to GWAS_SEX_wPC_Pheno1.log.
Options in effect:
  --bfile merged_Updated_2_QC_remove_related
  --covar 1KG_SEX_PCA_pheno.txt
  --covar-name Sex-PC5
  --glm firth-fallback cols=+a1freq hide-covar
  --out GWAS_SEX_wPC_Pheno1_2
  --pheno 1KG_SEX_PCA_pheno.txt
  --pheno-name Pheno1

Start time: Thu Oct 13 10:21:11 2022
128235 MiB RAM detected; reserving 64117 MiB for main workspace.
Using up to 56 threads (change this with --threads).
2873 samples (0 females, 0 males, 2873 ambiguous; 2873 founders) loaded from
merged_Updated_2_QC_remove_related.fam.
1836126 variants loaded from merged_Updated_22_QC.bim.
1 binary phenotype loaded (1466 cases, 1407 controls).
6 covariates loaded from 1KG_SEX_PCA_pheno.txt.
Calculating allele frequencies... done.
--glm logistic-Firth hybrid regression on phenotype 'Pheno1': done.
Results written to GWAS_SEX_wPC_Pheno1.Pheno1.glm.logistic.hybrid .
End time: Thu Oct 13 10:21:21 2022
```

* Look at the top 10 lines
```
...
1	965666	chr1:965666:ACC:A	ACC	A	A	0.0617821	N	ADD	2873	1.10558	0.11075	0.906299	0.364778	.
1	969663	chr1:969663:CAT:C	CAT	C	C	0.0603898	N	ADD	2873	1.13951	0.112817	1.15764	0.247012	.
1	973443	chr1:973443:G:A	G	A	A	0.0544727	N	ADD	2873	1.10933	0.116335	0.891848	0.372474	.
1	973862	chr1:973862:A:G	A	G	G	0.0544727	N	ADD	2873	1.02353	0.119036	0.195413	0.84507	.
1	973929	chr1:973929:T:C	T	C	C	0.105291	N	ADD	2873	1.13685	0.0857338	1.49609	0.13463	.
1	982260	chr1:982260:G:A	G	A	A	0.100244	N	ADD	2873	0.824471	0.0893716	-2.15967	0.0307984	.
